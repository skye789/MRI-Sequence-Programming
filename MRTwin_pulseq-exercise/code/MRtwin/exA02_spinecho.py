...
rf_event[3,0,1] = 90*np.pi/180  # 150+151,,mag倒在y轴
rf_event[3,1:,1] = 180*np.pi/180  #信号变成y轴对称位置
...
# event_time[-1,:] = 0.08*1e-3*30
event_time[3,1] =  0.08*1e-3*szread*0.5  #A02.3. 180pulse结束的时候就是信号产生的时候
